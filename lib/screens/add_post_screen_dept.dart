...
class AddPostDeptScreen extends StatefulWidget {
  final Function(Map<String, dynamic>) onPostAdded;
  String email;
  AddPostDeptScreen({super.key, required this.onPostAdded, required this.email});

  @override
  State<AddPostDeptScreen> createState() => _AddPostDeptScreenState();
}

class _AddPostDeptScreenState extends State<AddPostDeptScreen> with SingleTickerProviderStateMixin {
  File? _image;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          // Status section with toggle buttons
            ...
            children: [
              Expanded(
                child: ToggleButtons(
                  isSelected: [
                    _selectedStatus == "inprogress",
                    _selectedStatus == "solved",
                  ],
                  onPressed: (index) {
                    setState(() {
                      _selectedStatus = index == 0 ? "inprogress" : "solved";
                    });
                  },
                  borderRadius: BorderRadius.circular(8),
